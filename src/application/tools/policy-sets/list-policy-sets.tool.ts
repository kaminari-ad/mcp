...
import type { PolicySetSummary } from "../../../domain/ports/api-gateway.js";
...
export interface ListPolicySetsOutput {
  readonly items: readonly PolicySetSummary[];
...
export const listPolicySetsTool: Tool<ListPolicySetsInputShape, ListPolicySetsOutput> = {
  ...
  description:
      ...
      annotations: { title: "List Policy Sets", readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
