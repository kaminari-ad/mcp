...
export const listCampaignGroupsTool: Tool<
  ListCampaignGroupsInputShape,
  ListCampaignGroupsOutput
> = {
  name: "list_campaign_groups",
  description:
        "List campaign groups — folders that group related campaigns. Includes per-group campaign count.",
      annotations: { title: "List Campaign Groups", readOnlyHint: true, destructiveHint: false, idempotentHint: true, openWorldHint: false },
