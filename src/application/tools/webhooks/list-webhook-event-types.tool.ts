/**
 * Tool: `list_webhook_event_types` — catalog of events a webhook
 * can subscribe to.
 */

import { z } from "zod";

import type { EventCatalogEntryResponse } from "../../../domain/ports/api-gateway.js";
...
export interface ListWebhookEventTypesOutput {
  readonly items: readonly EventCatalogEntryResponse[];
