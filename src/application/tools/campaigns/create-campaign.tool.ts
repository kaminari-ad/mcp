...
export const createCampaignTool: Tool<CreateCampaignInputShape, CreateCampaignOutput> = {
  ...
  description:
      ...
      annotations: { title: "Create Campaign", readOnlyHint: false, destructiveHint: false, idempotentHint: false, openWorldHint: false },
  ...
  handler: async (input, ctx): Promise<Result<CreateCampaignOutput, ToolError>> => {
    const body = {
      ...
      ...(input.emulator_categories !== undefined ? { emulator_categories: input.emulator_categories } : {}),
